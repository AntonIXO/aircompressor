        ...
        extends InputStream
{
    ...
    private DecompressState decompressState = DecompressState.INITIAL_DECOMPRESS_STATE;

    private byte[] inputBuffer = new byte[decompressState.getInputRequired()];
            ...
            throws IOException
    {
        ...
        while (outputUsed < outputLength) {
            boolean enoughInput = fillInputBufferIfNecessary(decompressState.getInputRequired());
            if (!enoughInput) {
                if (decompressState.isAtStoppingPoint()) {
            ...
            inputBufferOffset += decompressState.getInputConsumed();
            outputUsed += decompressState.getOutputBufferUsed();
        }
        return outputUsed;
    }
            ...
            throws IOException
    {
        ...
        return decompressState.getRequestedOutputSize();
    }
