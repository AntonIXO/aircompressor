        ...
        extends TestZstd
{
    ...
    {
        super.testDecompressOutputBoundsChecks();
    }
    ...
    public void testDecompressWithOutputPaddingAndChecksum()
            throws IOException
    {
        super.testDecompressWithOutputPaddingAndChecksum();
    }
    ...
    public void testSmallLiteralsAfterIncompressibleLiterals()
            throws IOException
    {
        super.testSmallLiteralsAfterIncompressibleLiterals();
    }
    ...
    public void testIncompressibleData()
            throws IOException
    {
        super.testIncompressibleData();
    }

    @Override
    public void testMaxCompressedSize()
    {
        super.testMaxCompressedSize();
    }
    ...
    public void testVerifyMagicInAllFrames()
            throws IOException
    {
        super.testVerifyMagicInAllFrames();
    }
}
